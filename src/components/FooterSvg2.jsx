...
function FooterSvg2() {
  return (
    <svg width="65" height="56" fill="none" viewBox="0 0 65 56">
      <path fill="#BFE9FF" d="M57.03 20h-50v24h50V20z"></path>
      <path
        fill="#56B4FC"
      ...
      ></path>
      <path fill="#1652F0" d="M52.03 20h-40v24h40V20z"></path>
      <path
        fill="#fff"
